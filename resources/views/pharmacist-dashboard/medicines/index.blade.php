        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <!--begin::Add customer-->
                    <a href="{{ route('pharm-dashboard.medicines.create') }}" class="btn btn-primary">
                        ...
                        <td>
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('pharm-dashboard.medicines.show',$medicine) }}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('pharm-dashboard.medicines.edit',$medicine) }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form method="POST" action="{{ route('pharm-dashboard.medicines.destroy',$medicine) }}">
                                        @csrf
                                        @method('DELETE')
