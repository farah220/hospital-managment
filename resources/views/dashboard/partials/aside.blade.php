...
{{--        <!--end::Logo-->--}}
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
            ...
            <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
                    <a class="menu-link" href="{{route('dashboard.pharmacists.index')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        <span class="menu-title">Pharmacists List</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{route('dashboard.pharmacists.create')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        <span class="menu-title">New Pharmacist</span>
                    </a>
                </div>
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
            ...
            <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
                    <a class="menu-link" href="{{route('dashboard.departments.index')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        <span class="menu-title">Departments List</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{route('dashboard.departments.create')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        <span class="menu-title">New Department</span>
                    </a>
                </div>
...
{{--        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">--}}
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="{{route('dashboard.laboratorists.index')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{route('dashboard.laboratorists.create')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{route('dashboard.doctors.create')}}">
                                ...
                                <span class="menu-title">New Doctor</span>
                            </a>
                        </div>
...
{{--                                            <span class="bullet bullet-dot"></span>--}}
{{--                                        </span>--}}
{{--                        <span class="menu-title">New Departments</span>--}}
{{--                    </a>--}}
{{--                </div>--}}
...
{{--                </div>--}}
{{--                <div class="menu-item">--}}
{{--                    <a class="menu-link" href="{{route('dashboard.services.create')}}">--}}
{{--                                        <span class="menu-bullet">--}}
{{--                                            <span class="bullet bullet-dot"></span>--}}
{{--                                        </span>--}}
{{--                        <span class="menu-title">New Services</span>--}}
{{--                    </a>--}}
{{--                </div>--}}
