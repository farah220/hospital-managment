            ...
            <table class="table text-center align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                @forelse($pharmacists as $pharmacist)
                    <tr>
                        ...
                        <!--end::image=-->
                        <!--begin::Date=-->
                        <td>{{ date("m-d-Y" , strtotime($pharmacist->created_at)) }}</td>
                        <!--end::Date=-->
                        <!--begin::Action=-->
                        <td>
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.pharmacists.show',$pharmacist) }}"
                                       class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.pharmacists.edit',$pharmacist) }}"
                                ...
                                <div class="menu-item px-3">
                                    <form method="POST"
                                          action="{{ route('dashboard.pharmacists.destroy',$pharmacist) }}">
                                        @csrf
                                        @method('DELETE')
