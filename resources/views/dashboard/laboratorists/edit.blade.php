...
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <!-- begin :: Form -->
                <form action="{{ route('dashboard.laboratorists.update',$laboratorist->id) }}" class="form" method="POST"  enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                    ...
                    <div class="px-8 py-4">
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control"  name="name" value="{{ old('name') ?? $laboratorist->name }}" >
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control"  name="email" value="{{ old('email') ?? $laboratorist->email }}" >
