...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.patients.store') }}" class="form" method="post"
                ...
                <div class="px-8 py-4">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="email_inp" name="emergency_contact"
                                       placeholder="example" value="{{ old('emergency_contact') }}">
