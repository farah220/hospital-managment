...
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <!-- begin :: Form -->
                <form action="{{ route('dashboard.patients.show',$patient) }}" enctype="multipart/form-data" class="form" method="post" >
                @csrf
                <!-- begin :: Card header -->
                    <div class="card-header d-flex align-items-center">
                        <h3 class="fw-bolder text-dark"> Patient Details</h3>
                    </div>
                    <!-- end   :: Card header -->
                    ...
                    <div class="px-8 py-4">
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" disabled class="form-control"  value="{{ $patient->phone }}" />
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" disabled class="form-control" value="{{ $patient->email }}" >
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" disabled class="form-control" value="{{ $patient->emergency_contact }}" >
                    ...
                    <div class="form-footer p-8 text-end">
                        ...
                        <!-- begin :: Submit btn -->
                        <a class="btn btn-primary" href="{{ route('dashboard.patients.index') }}">
                            Back
                        </a>
                        <!-- end   :: Submit btn -->
