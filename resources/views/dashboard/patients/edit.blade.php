...
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <!-- begin :: Form -->
                <form action="{{ route('dashboard.patients.update',$patient->id) }}" enctype="multipart/form-data" class="form" method="POST" >
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->

                    <div class="card-header d-flex align-items-center">
                        <h3 class="fw-bolder text-dark"> Edit Patient</h3>
                    </div>
                    <!-- end   :: Card header -->
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control"  name="name" value="{{ old('name') ?? $patient->name }}" >
