        ...
        <div class="card-body pt-0">
            ...
            <table class="table text-center align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">Emergency Contact</th>
                        ...
                        <td>
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.patients.show',$patient) }}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.patients.edit',$patient) }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form method="POST" action="{{ route('dashboard.patients.destroy',$patient) }}">
                                        @csrf
                                        @method('DELETE')
