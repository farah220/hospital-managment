        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <!--begin::Add customer-->
                    <a href="{{ route('doctor-dashboard.prescriptions.create') }}" class="btn btn-primary">
                        ...
                        <td>
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('doctor-dashboard.prescriptions.show',$prescription) }}"
                                       class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('doctor-dashboard.prescriptions.edit',$prescription) }}"
                                ...
                                <div class="menu-item px-3">
                                    <form method="POST"
                                          action="{{ route('doctor-dashboard.prescriptions.destroy',$prescription) }}">
                                        @csrf
                                        @method('DELETE')
