                    ...
                    <div
                        ...
                        <div class="menu-item me-lg-1">
                            <a class="menu-link active py-3" >
                                <span class="menu-title">Lab Dashboard</span>
                            </a>
                        </div>
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img src="{{ asset('storage/images/laboratorists/' . auth()->user()->image) }}"
                                 alt="metronic"/>
                        </div>
                        <!--begin::Menu-->
                        <div
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo"
                                             src="{{ asset('storage/images/laboratorists/' . auth()->user()->image) }}"/>
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                            ...
                            <div class="menu-item px-5">
                                <form method="POST" action="{{route('lab-dashboard.logout')}}">
                                    @csrf
